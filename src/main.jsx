  ...
  <StrictMode>
    ...
    <div style={{ display: "none" }}>
      <section aria-hidden="true">
        <h1>Bhumisvara MS - Creative Developer</h1>
        <h2>B.Sc AIML Student at Paavai Engineering College</h2>
      ...
      <section aria-hidden="true">
        <p>
          Welcome to the 3D portfolio of Bhumisvara MS. This immersive portfolio has
      ...
      <noscript>
        <p>
          This 3D portfolio of Bhumisvara MS showcases creative web development using
